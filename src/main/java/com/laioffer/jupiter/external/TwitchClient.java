...
public class TwitchClient {
    private static final String TOKEN = "Bearer qhnikzu0r0pob5s3kfqnt7xpausvx6";
    private static final String CLIENT_ID = "ec3nw05d9cf04uggh5oslkqu1pnvv8";
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        // Define the response handler to parse
    ...
    private String buildSearchURL(String url, String gameId, int limit) {
        try {
            gameId = URLEncoder.encode(gameId, "UTF-8"); //e.g. space...
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
